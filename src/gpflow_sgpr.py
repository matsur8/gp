...
def get_hyp(model):
    ...
    return {"lengthscale": model_tbl.loc["SGPR/kern/lengthscales", "value"]*1,
            "variance": model_tbl.loc["SGPR/kern/variance", "value"]*1,
            "noise_variance": model_tbl.loc["SGPR/likelihood/variance", "value"]*1}
